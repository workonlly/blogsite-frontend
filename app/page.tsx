...
const ProfessionalLayout = () => {
  return (
    <div className="min-h-screen flex flex-col font-sans bg-slate-50">
      ...
      <main className="flex-grow p-4 md:p-4 max-w-7xl mx-auto w-full font-sans bg-gray-50">
     ...
     <Banner></Banner>
      ...
      <section>
        <div className="mb-12 flex flex-col items-start">
          {/* Subtle accent line above the text */}
          <div className="w-16 h-1 bg-indigo-500 rounded-full mb-4"></div>
          
          <h2 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-black tracking-tight">
            Latest Blogs
          </h2>
          <p className="text-gray-400 mt-3 text-sm md:text-base">
            Insights, trends, and tutorials from the bleeding edge of tech.
          </p>
        </div>
        <Posts></Posts>
